...
# This script tears down the radius example in all regions. It deletes the
...
# 1. TODO: Remove all objects from the RADIUS archive S3 bucket in each region so the buckets can be removed.
